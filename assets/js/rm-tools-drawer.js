...
(function(){
  const tools = [
    ...
    { id:"video-resize-reduce-size", name:"Video Resize / Reduce Size", icon:"🎞️", desc:"Compress and resize videos locally in your browser to meet upload limits." },
    { id:"split-video-into-clips", name:"Split Video into Clips", icon:"✂️", desc:"Split a video by time ranges, fixed durations, equal parts, or approximate file size." },
    { id:"merge-videos-join-clips", name:"Merge Videos / Join Clips", icon:"🧩", desc:"Join multiple video clips into one MP4. Fast join or compatible re-encode." },
